...
class LoginManager:
    ...
    application in a factory function.
    """
    ...
    def init_app(self, app, add_context_processor=True):
        ...
        attaches this `LoginManager` to it as `application.login_manager`.

        :param app: The :class:`flask.Flask` object to configure.
        :type app: :class:`flask.Flask`
        :param add_context_processor: Whether to add a context processor to
            the application that adds a `current_user` variable to the template.
            Defaults to ``True``.
    ...
    def unauthorized(self):
        ...
        be called. Otherwise, it will take the following actions:
            ...
            - If the application is using blueprints find the login view for
              the current blueprint using `blueprint_login_views`. If the application
    ...
    def _login_disabled(self):
        """Legacy property, use application.config['LOGIN_DISABLED'] instead."""
        if has_app_context():
    ...
    def _login_disabled(self, newvalue):
        """Legacy property setter, use application.config['LOGIN_DISABLED'] instead."""
