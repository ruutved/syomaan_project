...
This example dispatches to an API application under "/api", an admin application
under "/admin", and an application that serves frontend files for all other
requests::

    application = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
