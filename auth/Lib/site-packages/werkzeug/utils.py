...
def send_file(
    ...
    if isinstance(path_or_file, (os.PathLike, str)) or hasattr(
        ...
        # Flask will pass application.root_path, allowing its send_file wrapper
    ...
    # Flask will pass application.get_send_file_max_age, allowing its send_file
...
def send_from_directory(
    ...
    **kwargs: t.Any,
    ...
    # Flask will pass application.root_path, allowing its send_from_directory
    # wrapper to not have to deal with paths.
        ...
        for part in import_name.replace(":", ".").split("."):
            ...
            if imported:
                ...
                msg = (
                    ...
                    f" are:\n\n"
                    "- missing application.py in a package;\n"
